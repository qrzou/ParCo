...
trans_uplow_cfg = {
    'default': dict(  # Same dim as the body part version
...
def get_args_parser(args=None):
    ...
    parser.add_argument("--fuse-ver", type=str, default='V1_2', choices=['V1', 'V1_2', 'V1_3', 'V2', 'V2_2'], help="Fuse module structure")
