...
val_loader = dataset_TM_eval_uplow.DATALoader(args.dataname, True, 32, w_vectorizer)
...
for i in range(repeat_time):
    ...
    if i < mmod_times:  # 0~4
        best_fid, best_iter, best_div, best_top1, best_top2, best_top3, best_matching, best_multi, writer, logger = eval_uplow.evaluation_transformer_test_batch(test_npy_save_dir, val_loader, net, trans_encoder, logger, writer, 0, best_fid=1000, best_iter=0, best_div=100, best_top1=0, best_top2=0, best_top3=0, best_matching=100, best_multi=0, clip_model=clip_model, eval_wrapper=eval_wrapper, draw=False, savegif=False, save=False, savenpy=False, mmod_gen_times=30, skip_mmod=False)
