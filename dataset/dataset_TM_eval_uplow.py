...
class Text2MotionDataset(data.Dataset):
    ...
    def uplow2whole(self, parts, mode='t2m', shared_joint_rec_mode='Avg'):
        rec_data = uplow2whole(parts, mode, shared_joint_rec_mode)
        return rec_data
    ...
    def __getitem__(self, item):
        ...
        uplow = self.whole2uplow(motion, mode=self.dataset_name)  # [Upper_body, Lower_body]
        ...
        return word_embeddings, pos_one_hots, caption, sent_len, motion, m_length, '_'.join(tokens), name, uplow
